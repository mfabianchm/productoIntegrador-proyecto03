            ...
            <div className="col-lg-12">
              ...
              >
                <div className="item">
                  ...
                  <div className="valign">
                    <p className="fz-20 fw-200">
                      No he probado mejores cafés en otro lado, sin duda lo
                      recomiendo.
                    </p>
                  </div>
                </div>
                <div className="item">
                  ...
                  <div className="valign">
                    <p className="fz-20 fw-200">
                      A mi familia le encanta el aroma y textura de sus
                      productos, creo que es el mejor café que he probado.
                    </p>
                  </div>
                </div>
                <div className="item">
                  ...
                  <div className="valign">
                    <p className="fz-20 fw-200">
                      Me dieron todo lo necesario para comenzar mi propio
                      negocio, desde maquinas hasta decoración de interiores.
                    </p>
                  </div>
                </div>
                <div className="item">
